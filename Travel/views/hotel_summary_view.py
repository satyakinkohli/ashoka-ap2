...
class Hotel_Summary_View(View):
    def get(self,request):
        ...
        price_per_night = (int(standard_number)*float(hotel_instance.standard_price)) + (int(deluxe_number)*float(hotel_instance.deluxe_price)) + (int(premium_number)*float(hotel_instance.premium_price)) + (int(suite_number)*float(hotel_instance.suite_price))
        print(price_per_night)
        total_price = price_per_night*int(days.days)
        print(total_price)
        summary_data = {'hotel':hotel_instance , 'hotel_check_in':hotel_check_in , 'hotel_check_out':hotel_check_out , 'days':days.days , 'price_per_night':price_per_night, 'total_price':total_price}
